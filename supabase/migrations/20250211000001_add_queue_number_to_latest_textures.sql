-- Update get_latest_textures_for_viewer to include queue_number from texture_queue
...
BEGIN
  ...
  LEFT JOIN texture_queue tq ON tq.texture_id = mt.id AND tq.viewer_id = p_viewer_id
